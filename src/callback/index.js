...
function sum(num1, num2) {
  //funcion 1, recibe como parametro 2 numeros
  return num1 + num2; //retorna el resultado de la sumatoria
}

function calc(num1, num2, callback) {
  //funcion 2, recibe como parametro 2 numeros enteros ademas de la funcion suma
...
function gretting(name) {
  // Funcion de saludar con parametro String
...
function PruebaCallBack() {
  //funcion 1, Muestra cadena en consola
